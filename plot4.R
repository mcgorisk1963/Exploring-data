...
subdf3[["Voltage"]] <- as.numeric(subdf3[["Voltage"]] )
subdf3[["Global_reactive_power"]] <- as.numeric(subdf3[["Global_reactive_power"]] )
...
plot(x, subdf3$Global_active_power,"l", xlab="", ylab="Global Active Power")
plot(x, subdf3$Voltage,"l", ylab="Voltage", xlab="DateTime")
...
plot(x, subdf3$Global_reactive_power,ylab="Global Reactive Power", xlab="DateTime", "l")
